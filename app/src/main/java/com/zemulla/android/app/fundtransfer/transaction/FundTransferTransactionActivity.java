...
import com.zemulla.android.app.transaction.HistoryFragment;

import java.util.ArrayList;
import java.util.List;

public class FundTransferTransactionActivity extends AppCompatActivity {

    private Toolbar toolbar;
    private TextView txtMainTitle;
    private TabLayout viewpagertab;
    private ViewPager viewpager;
    private ArrayList<FundTransferTileBean> TILES;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fund_transfer_transaction);
        initToolbar();
    ...
    private void setTab() {
        ...
        TILES = configuration.getAllFundTransferOptions();
