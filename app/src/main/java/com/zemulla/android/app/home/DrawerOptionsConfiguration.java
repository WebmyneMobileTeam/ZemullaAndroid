...
public class DrawerOptionsConfiguration {
    ...
    public String[] options = {"View Profile","Update KYC","Change Password","Logout"};
    ...
    public OptionID[] ids = {OptionID.VIEW_PROFILE,OptionID.UPDATE_KYC,OptionID.CHANGE_PASSWORD,OptionID.LOGOUT};
