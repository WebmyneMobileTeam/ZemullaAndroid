package com.zemulla.android.app.fundtransfer.zoona;
...
public class ZoonaCashTransferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zoona_cash_transfer);
        ...
        checkRateFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Functions.isEmpty(edtAmount)) {
                    Functions.showError(ZoonaCashTransferActivity.this, "Please Enter Amount", false);
                    return;
                }
                calculateAmount();
