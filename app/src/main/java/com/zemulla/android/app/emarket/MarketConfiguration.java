...
public class MarketConfiguration {
    ...
    public String[] names = {"AirTime Topup Zambia", "Pay Electricity Bill", "Direct Recharge", "DSTV Payment"};
...
//    private String[] colorsDark = {"#00695C", "#2E7D32", "#558B2F", "#9E9D24", "#00695C", "#2E7D32", "#558B2F"};
    private String[] colors = {"#ffffff", "#EEEEEE", "#EEEEEE", "#ffffff"};
    private String[] colorsDark = {"#494949", "#9E9E9E", "#9E9E9E", "#494949"};


    private TOPUP_IDTILE[] ids = {TOPUP_IDTILE.AIRTIME_TOPUP, TOPUP_IDTILE.ELECTRICITY, TOPUP_IDTILE.DTH, TOPUP_IDTILE.DSTV};
    ...
    public ArrayList<MarketTileBean> getAllMarketOptions() {
