 ...
 */
public class DSTVProductAdapter extends ArrayAdapter<DSTVProduct> {


    private Context context;
    private LayoutInflater inflater;

    public DSTVProductAdapter(Context context) {
        super(context, 0);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        DSTVProduct dstvProduct = getItem(position);
        viewHolder.txtTitle.setText(String.format("%s", dstvProduct.getProduct_provider()));
        return convertView;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        DSTVProduct dstvProduct = getItem(position);
        txt.setText(String.format("%s", dstvProduct.getProduct_provider()));
