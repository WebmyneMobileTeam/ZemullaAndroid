...
public class FundTransferConfiguration {
    ...
    public static String[] names = {"Zemulla Wallet", "MTN", "Airtel Money", "Zoona Cash", "Bank Transfer"};
...
//    private String[] colorsDark = {"#00695C", "#2E7D32", "#558B2F", "#9E9D24", "#00695C", "#2E7D32", "#558B2F"};
    private static String[] colors = {"#ffffff", "#EEEEEE", "#EEEEEE", "#ffffff", "#ffffff"};
    private static String[] colorsDark = {"#494949", "#9E9E9E", "#9E9E9E", "#494949", "#494949"};


    private static FundTransfer_IDTILE[] ids = {FundTransfer_IDTILE.Zemulla_Wallet, FundTransfer_IDTILE.MTN,
    ...
    public static ArrayList<FundTransferTileBean> getAllFundTransferOptions() {
