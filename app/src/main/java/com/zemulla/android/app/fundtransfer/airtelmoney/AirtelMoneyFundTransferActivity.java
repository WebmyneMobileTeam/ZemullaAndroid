package com.zemulla.android.app.fundtransfer.airtelmoney;
...
public class AirtelMoneyFundTransferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airtel_money_fund_transfer);
        ...
        checkRateFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Functions.isEmpty(edtAmount)) {
                    Functions.showError(AirtelMoneyFundTransferActivity.this, "Please Enter Amount", false);
                    return;
                }
                calculateAmount();
