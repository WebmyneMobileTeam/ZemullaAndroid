 ...
 */
public class GetTopUpApiReportDetailsAPI {

    private ReportsAPI paymentAPI;
    private APIListener apiListener;
    Call<GetTopUpApiReportDetailsResponse> call;

    public GetTopUpApiReportDetailsAPI() {

        paymentAPI = ZemullaApplication.getRetrofit().create(ReportsAPI.class);
    }

    public void getTopUpWalletBankTransferApi(final ReportRequest reportRequest, final APIListener apiListener) {
        this.apiListener = apiListener;
        call = paymentAPI.getTopUpApiReportDetails(reportRequest);
